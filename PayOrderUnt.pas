...
//根据手机号查询会员编号
  ...
  if qry.IsEmpty then
    ...
    begin
      ...
      begin
         cardnum_edt.Lines.Add('卡面编号:'+ qry.fieldbyname('MCSHOWID').AsString);
         cardnum_edt.Lines.Add('卡号：'+qry.fieldbyname('MCID').AsString);
         cardnum_edt.Lines.Add('余额:'+qry.fieldbyname('MMONEY').AsString);
         qry.Next;
      end;
